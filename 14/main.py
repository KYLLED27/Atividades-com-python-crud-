...
def contagem():
    for fez_checkin in convidados:
        if fez_checkin["checking"]:
            print("Convidados que fizeram check-in:", fez_checkin["nome"])
        else:
            print("Nenhum Convidado fez check-in")
            
def cadastrar():
    nome=input("digite seu nome: ")
    cpf=input("digite seu cpf: ")
    convidado = {"nome": nome, "cpf": cpf, "checking": False}
